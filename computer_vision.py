...
class ComputerVision():
    ...
    def detectables_setup(self):
        ...
        self.regions["Give Harmony Orb"] = {"Rect": [945, 995, 725, 775]}
        self.regions["Give Discord Orb"] = {"Rect": [945, 995, 1145, 1195]}
        self.regions["Give Mercy Heal"] = {"Rect": [655, 723, 790, 858]}
        self.regions["Give Mercy Boost"] = {"Rect": [655, 723, 1062, 1130]}
        self.regions["Receive Heal"] = {"Rect": [740, 840, 440, 650]}
    ...
    async def update(self):
        ...
        for d in self.detectables:
            ...
            if (self.detectables[d]["Type"] == 0):
                ...
                self.score_over_time += delta_time * self.detectables[d]["Count"] * self.detectables[d]["Points"] 
            elif (self.detectables[d]["Type"] == 2):
                self.score_over_time += delta_time * self.detectables[d]["Count"] * self.detectables[d]["Points"] / self.detectables[d]["Duration"]
    ...
    def update_other_detections(self):
        ...
        self.match_detectables_on_region("Receive Heal", ["Receive Zen Heal"])
        self.match_detectables_on_region("Receive Heal", ["Receive Mercy Boost", "Receive Mercy Heal"])
    ...
    def match_detectables_on_region(self, regionKey, detectableKeys, operation = None):
        ...
        if (match is not None):
            self.regions[regionKey]["Matches"].append(match)
        return match
